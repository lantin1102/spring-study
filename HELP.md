...
* The following dependencies are not known to work with Spring Native: 'MyBatis Framework, Spring Boot DevTools, Spring
...
```
$ docker run --rm -p 8080:8080 spring-study:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/spring-study
```
